...
<div align="center">
  <a href="https://www.linkedin.com/in/barot-dharmik2105"><img src="https://img.shields.io/badge/ENTER_LINKEDIN-0B1220?style=flat-square&logo=linkedin&logoColor=5EEAD4" alt="LinkedIn" /></a>
  <a href="mailto:dharmik.aieng@gmail.com"><img src="https://img.shields.io/badge/SEND_A_SIGNAL-0B1220?style=flat-square&logo=gmail&logoColor=5EEAD4" alt="Email" /></a>
  <img src="https://komarev.com/ghpvc/?username=dharmik-21&label=SIGNALS+RECEIVED&color=14B8A6&style=flat-square" alt="Profile views" />
</div>
...
```mermaid
flowchart LR
  A[Real human problem] --> B[Make the data usable]
  B --> C[Choose the simplest capable model]
  C --> D[Build the experience around it]
  D --> E[Measure what actually improved]
  E -. learn .-> A
```
